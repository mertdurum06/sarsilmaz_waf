  ...
  <div class="p-4">
    <div class="welcome">
      <div class="content rounded-3 p-3">
        <center><h1 class="fs-3">Duyuru Düzenle</h1></center>
      </div>
    </div>
...
<div>
    <form action="d-duzenle.php" method="POST">
    <div class="p-4">
    <div class="welcome">
    <div class="content rounded-3 p-3">
      <label>ID : </label>
      ...
      <label>Bağlantı : </label>
        <input type="text" name="link" id="link" style="background: transparent; border: none; color: white;" required="yes">
      </div>

      <br>

      <div class="content rounded-3 p-3">
        <center><a><input type="submit" style="background: transparent; border: none; color: #00ffff;" value="Duyuru Düzenle" /></a></center>
      </div>
    </div>
    </div>
    </form>
