  ...
  <div class="p-4">
    <div class="welcome">
      <div class="content rounded-3 p-3">
        <center><h1 class="fs-3">Duyuru Sil</h1></center>
      </div>
    </div>
    ...
    <div>
        <form action="d-sil.php" method="POST">
        <div class="p-4">
        <div class="welcome">
        <div class="content rounded-3 p-3">
          ...
          <div class="content rounded-3 p-3">
            <center><a><input type="submit" style="background: transparent; border: none; color: red;" value="Duyuru Sil" /></a></center>
          </div>
