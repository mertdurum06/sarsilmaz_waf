...
<head>
  ...
  <title>MEÜ | Yönetim Paneli</title>
  ...
  <div class="p-4">
    <div class="welcome">
      <div class="content rounded-3 p-3">
        <center><h1 class="fs-3">Site Başlığı Düzenle</h1></center>
      </div>
    </div>
...
<div>
    <form action="b-duzenle.php" method="POST">
    <div class="p-4">
    <div class="welcome">
      <div class="content rounded-3 p-3">
      <label>Başlık : </label>
      ...
      <div class="content rounded-3 p-3">
        <center><a><input type="submit" style="background: transparent; border: none; color: #00ffff;" value="Başlığı Değiştir" /></a></center>
      </div>
    </div>
    </div>
    </form>
