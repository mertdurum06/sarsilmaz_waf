  ...
  <div class="p-4">
    <div class="welcome">
      <div class="content rounded-3 p-3">
        <center><h1 class="fs-3">Yönetici Paneli</h1></center>
      </div>
    </div>
    ...
    <div class="welcome">
    <div class="content rounded-3 p-3">
    <!-- <label>Oturum açan kullanıcı : </label> <span class="main-color"><?php $str = strtoupper($username); echo $str;?></span> -->
    <br>
    <br>
    <!--<label>Oturum açan kullanıcı ID'si : </label> <span class="main-color"><?php print_r($sonuc["id"]);?></span> -->
    <br>
    <br>
    <center><label>Kullancı Listesi</label></center>
    <br>
    <br>
    <?php
