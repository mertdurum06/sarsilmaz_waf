  ...
  <div class="p-4">
    <div class="welcome">
      <div class="content rounded-3 p-3">
        <center><h1 class="fs-3">Haber Düzenle</h1></center>
      </div>
    </div>
...
<div>
    <form action="h-duzenle.php" method="POST">
    <div class="p-4">
    <div class="welcome">
    <div class="content rounded-3 p-3">
      <label>ID : </label>
      ...
      <div class="content rounded-3 p-3">
      <label>Başlık : </label>
        <input type="text" name="baslik" id="baslik" style="background: transparent; border: none; color: white;" required="yes">
      </div>
      ...
      <label>Açıklama : </label>
        <input type="text" name="aciklama" id="aciklama" style="background: transparent; border: none; color: white;" required="yes">
      </div>
      ...
      <div class="content rounded-3 p-3">
      <label>Görsel : </label>
        <input type="text" name="gorsel" id="gorsel" style="background: transparent; border: none; color: white;" required="yes">
      </div>

      <br>

      <div class="content rounded-3 p-3">
        <center><a><input type="submit" style="background: transparent; border: none; color: #00ffff;" value="Haberi Düzenle" /></a></center>
      </div>
    </div>
    </div>
    </form>
