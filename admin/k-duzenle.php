...
$sorgu4->bindParam(':username', $username); // Bind the parameter
$sorgu4->execute();
...
$sorguUpdate = $veritabani->prepare("UPDATE user SET username=:newUsername WHERE id=:id");
$sorguUpdate->bindParam(':newUsername', $usernamed);
$sorguUpdate->bindParam(':id', $id);
$sorguUpdate->execute();
