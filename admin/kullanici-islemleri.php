  ...
  <div class="p-4">
    <div class="welcome">
      <div class="content rounded-3 p-3">
        <center><h1 class="fs-3">Kullanıcı İşlemleri</h1></center>
      </div>
    </div>
    ...
    <div>
    <form action="k-duzenle.php" method="POST">
    <div class="p-4">
    <div class="welcome">
      <br>
      <div class="content rounded-3 p-3">
      <label>Kullanıcı Adı : </label>
        <input type="text" name="username-d" id="username-d" style="background: transparent; border: none; color: white;" required="yes">
      </div>

      <br>

      <div class="content rounded-3 p-3">
        <center><a><input type="submit" style="background: transparent; border: none; color: #00ffff;" value="Kullanıcı Adı Değiştir" /></a></center>
      </div>
    </div>
    </div>
    </form>
...
<div>
    <form action="s-duzenle.php" method="POST">
    <div class="p-4">
    <div class="welcome">
      <br>
      <div class="content rounded-3 p-3">
      <label>Şifre : </label>
        <input type="password" name="password-d" id="password-d" style="background: transparent; border: none; color: white;" required="yes">
      </div>

      <br>

      <div class="content rounded-3 p-3">
        <center><a><input type="submit" style="background: transparent; border: none; color: #00ffff;" value="Şifre Değiştir" /></a></center>
      </div>
    </div>
    </div>
    </form>
...
<div>
    <form action="k-ekle.php" method="POST">
    <div class="p-4">
    <div class="welcome">
      <br>
      <div class="content rounded-3 p-3">
      <label>Kullanıcı Adı : </label>
        <input type="text" name="uname" id="uname" style="background: transparent; border: none; color: white;" required="yes">
      </div>
      ...
      <div class="content rounded-3 p-3">
      <label>Şifre : </label>
        <input type="password" name="passwd" id="passwd" style="background: transparent; border: none; color: white;" required="yes">
      </div>

      <br>

      <div class="content rounded-3 p-3">
        <center><a><input type="submit" style="background: transparent; border: none; color: #25c67b;" value="Kullanıcı Ekle" /></a></center>
      </div>
    </div>
    </div>
    </form>
    ...
    <div>
    <form action="k-sil.php" method="POST">
    <div class="p-4">
    <div class="welcome">
      <div class="content rounded-3 p-3">
        <center><a><input type="submit" style="background: transparent; border: none; color: red;" value="Kullanıcıyı Sil" /></a></center>
      </div>
    </div>
    </div>
    </form>
